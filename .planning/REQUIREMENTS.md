...
- [x] **UI-03**: Partition create/edit page (/partitions/new, /partitions/{id}/edit) — name/description/timers fields, camera selector grouped by NVR with per-NVR sync button
- [x] **UI-04**: NVR management page (/nvrs) — list NVRs with status badge, add NVR form, test connectivity button (inline HTMX result), last seen timestamp
